...
def main():
    ...
    parser.add_argument('file_name_2', metavar='file_name_2', type=str, help='input file name')
    ...
    bp0 = ax0.boxplot((result0[:, 0], result1[:, 0], result2[:, 0]), whis="range", showmeans=True, meanline=True)
    ...
    print(method_name1 + " mean: " + str(result1[result1[:, 2]==0, 0].mean()) + "[m]")
    ...
    print(method_name2 + " mean: " + str(result2[result2[:, 2]==0, 0].mean()) + "[m]")
    ...
    print(stats.ttest_ind(result0[result0[:, 2]==0, 0], result2[result2[:, 2]==0, 0], equal_var=False))

    bp1 = ax1.boxplot((result0[:, 1], result1[:, 1], result2[:, 1]), whis="range", showmeans=True, meanline=True)
    ...
    print(method_name1 + " mean: " + str(result1[result1[:, 2]==0, 1].mean()) + "[s]")
    ...
    print(method_name2 + " mean: " + str(result2[result2[:, 2]==0, 1].mean()) + "[s]")
    ...
    print(stats.ttest_ind(result0[result0[:, 2]==0, 1], result2[result2[:, 2]==0, 1], equal_var=False))

    bp2 = ax2.boxplot((result0[:, 2], result1[:, 2], result2[:, 2]), whis="range", showmeans=True, meanline=True)
    ...
    print(method_name1 + " c. rate: " + str(np.where(result1[:, 2] > 0)[0].shape[0] / float(result1[:, 2].shape[0])))
    ...
    print(method_name2 + " c. rate: " + str(np.where(result2[:, 2] > 0)[0].shape[0] / float(result2[:, 2].shape[0])))
    print(stats.ttest_ind(result0[:, 2], result2[:, 2], equal_var=False))

    bp3 = ax3.boxplot((result0[:, 3], result1[:, 3], result2[:, 3]), whis="range", showmeans=True, meanline=True)
    ...
    print(method_name1 + " mean: " + str(result1[result1[:, 2]==0, 3].mean()) + "[m]")
    ...
    print(method_name2 + " mean: " + str(result2[result2[:, 2]==0, 3].mean()) + "[m]")
    ...
    print(stats.ttest_ind(result0[result0[:, 2]==0, 3], result2[result2[:, 2]==0, 3], equal_var=False))
