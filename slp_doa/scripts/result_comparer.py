...
def main():
    ...
    ax0.set_xticklabels(['Proposed method', 'CADRL'])
    ...
    print("CADRL mean: " + str(result1[:, 0].mean()) + "[m]")
    print("CADRL median: " + str(np.median(result1[:, 0])) + "[m]")
    ...
    ax1.set_xticklabels(['Proposed method', 'CADRL'])
    ...
    print("CADRL mean: " + str(result1[:, 1].mean()) + "[s]")
    print("CADRL median: " + str(np.median(result1[:, 1])) + "[s]")
    ...
    ax2.set_xticklabels(['Proposed method', 'CADRL'])
    ...
    print("CADRL mean: " + str(result1[:, 2].mean()))
    print("CADRL median: " + str(np.median(result1[:, 2])))
    print("CADRL. c. rate: " + str(np.where(result1[:, 2] > 0)[0].shape[0] / float(result1[:, 2].shape[0])))
    ...
    ax3.set_xticklabels(['Proposed method', 'CADRL'])
    ...
    print("CADRL mean: " + str(result1[:, 3].mean()) + "[m]")
    print("CADRL median: " + str(np.median(result1[:, 3])) + "[m]")
